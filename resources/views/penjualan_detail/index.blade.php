                ...
                <div class="box-body">
                    ...
                    <form class="form-produk">
                        ...
                        <div class="form-group row">
                            <label for="kode_produk" class="col-lg-2">Product Code / Barcode</label>
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        <button id="start-scanner" class="btn btn-primary" type="button"><i
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let startScannerButton = document.getElementById('start-scanner');
            let lastResult;
            ...
            function onScanSuccess(decodedText, decodedResult) {
                ...
                <div>
                    <b>Scanned Result:</b> ${decodedText}
                </div>
            `;
                    pilihProduk(decodedText, decodedText)
                }
            }
