...
class PenjualanDetailController extends Controller
{
    ...
    {
        $produk = Produk::where('id_produk', $request->id_produk)->orWhere('kode_produk', $request->kode_produk)->first();
        if (!$produk) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($detail->produk->stok < $request->jumlah) {
            return response()->json('Stok produk tidak cukup', 422);
        }
